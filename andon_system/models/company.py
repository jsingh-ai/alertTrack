...
class Company(db.Model):
    ...
    user_access = db.relationship("UserCompanyAccess", back_populates="company", lazy="selectin")
    user_view_preferences = db.relationship("UserViewPreference", back_populates="company", lazy="selectin")
    ...
    pager_devices = db.relationship("PagerDevice", back_populates="company", lazy="selectin")
